...
public class CalculatorFrame extends javax.swing.JFrame {
    ...
    switch (operator) {
        case 1:  // Cộng
            ...
            history.add(num + " + " + inputText + " = " + ans);  // Lưu phép toán vào lịch sử
            break;
        case 2:  // Trừ
            ans = num - Double.parseDouble(jTextField1.getText());
            jTextField1.setText(Double.toString(ans));
        ...
        case 5:  // Phần trăm
            ans = num / 100;
            jTextField1.setText(Double.toString(ans));
            history.add(num + " % = " + ans);  // Lưu phép toán vào lịch sử
            break;
        case 6:  // Lũy thừa
            ans = Math.pow(num, Double.parseDouble(inputText));
            jTextField1.setText(Double.toString(ans));
            history.add(num + "^" + inputText + " = " + ans);  // Lưu phép toán vào lịch sử
            break;
        case 7:  // Căn bậc hai
            ans = Math.sqrt(Double.parseDouble(inputText));
            jTextField1.setText(Double.toString(ans));
            history.add("√" + inputText + " = " + ans);  // Lưu phép toán vào lịch sử
            break;
    }
                    ...
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                        ...
                        .addGroup(jPanel1Layout.createSequentialGroup()
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addComponent(jButtonBS1, javax.swing.GroupLayout.Alignment.TRAILING))
                            .addGap(18, 18, 18)
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(jPanel1Layout.createSequentialGroup()
